                    ...
                    children: [
                      _jsx(Route, {
                        ...
                        element: _jsx(AuthLayout, {
                          children: _jsx(RegisterLoginPage, { onLoginSuccess: checkAuthStatus }),
                        }),
                      }),
                      _jsx(Route, { path: '*', element: _jsx(Navigate, { to: '/auth', replace: true }) }),
                    ],
                  })
                : _jsxs(_Fragment, {
                    children: [
                      _jsx(Route, { path: '/auth', element: _jsx(Navigate, { to: '/', replace: true }) }),
                      _jsx(Route, { path: '/', element: _jsx(MainLayout, { children: _jsx(LandingPage, {}) }) }),
                      _jsx(Route, {
                        path: '/venue/:id',
                        element: _jsx(MainLayout, { children: _jsx(VenueDetailsPage, {}) }),
                      }),
                      _jsx(Route, {
                        path: '/manage-venue',
                        element: _jsx(MainLayout, { children: _jsx(ManageVenuePage, {}) }),
                      }),
                      _jsx(Route, {
                        path: '/newvenue',
                        element: _jsx(MainLayout, { children: _jsx(NewVenuePage, {}) }),
                      }),
                      _jsx(Route, {
                        path: '/hostpage/:name',
                        element: _jsx(MainLayout, { children: _jsx(AllHostsPage, {}) }),
                      }),
                      _jsx(Route, { path: '/about', element: _jsx(MainLayout, { children: _jsx(AboutPage, {}) }) }),
                      _jsx(Route, {
                        path: '/user-overview',
                        element: _jsx(MainLayout, { children: _jsx(UserOverviewPage, {}) }),
                      }),
                    ],
                  }),
