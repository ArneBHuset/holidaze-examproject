  ...
  return _jsx(MainCard, {
    children: _jsx(FormControl, {
      ...
      children: _jsxs(Grid, {
        ...
        p: 2,
        children: [
          _jsx(Box, { width: '100%', children: _jsx(SubTitle, { children: 'USER TYPE' }) }),
          _jsx(Grid, {
            size: { xs: 12, sm: 6 },
            width: '100%',
            children: _jsxs(Box, {
              ...
              children: [
                _jsx(Controller, {
                  ...
                  render: ({ field }) =>
                    _jsx(Checkbox, {
                      ...
                      icon: _jsx(TravelExploreIcon, { sx: { fontSize: 45 } }),
                      checkedIcon: _jsx(TravelExploreIcon, { sx: { fontSize: 45 } }),
                      sx: {
                ...
                _jsx(Typography, { variant: 'subtitle1', children: 'CUSTOMER' }),
              ],
            }),
          }),
          _jsx(Grid, {
            ...
            children: _jsxs(Box, {
              ...
              children: [
                _jsx(Controller, {
                  ...
                  render: ({ field }) =>
                    _jsx(Checkbox, {
                      ...
                      icon: _jsx(VillaIcon, { sx: { fontSize: 40 } }),
                      checkedIcon: _jsx(VillaIcon, { sx: { fontSize: 40 } }),
                      sx: {
                        color: theme.palette.primary.light,
                        '&.Mui-checked': {
                          color: theme.palette.secondary.main,
                ...
                _jsx(Typography, { variant: 'subtitle1', children: 'VENUE MANAGER' }),
              ],
            }),
          }),
          _jsx(Grid, {
          ...
          _jsx(Grid, {
            ...
            children: _jsxs(Box, {
              children: [
                _jsx(SubTitle, { children: 'Password' }),
                _jsx(Controller, {
                  name: 'password',
                  control: control,
                  defaultValue: '',
          ...
          _jsx(Grid, {
            ...
            children: _jsxs(Box, {
              children: [
                _jsx(SubTitle, { children: 'Avatar description' }),
                _jsx(Controller, {
                  name: 'avatar.alt',
                  control: control,
                  render: ({ field }) =>
          ...
          _jsx(Grid, {
            ...
            children: _jsxs(Box, {
              children: [
                _jsx(SubTitle, { children: 'Banner picture' }),
                _jsx(Controller, {
                  name: 'banner.url',
                  control: control,
                  render: ({ field }) =>
          ...
          _jsx(Grid, {
            ...
            children: _jsxs(Box, {
              children: [
                _jsx(SubTitle, { children: 'Banner description' }),
                _jsx(Controller, {
                  name: 'banner.alt',
                  control: control,
                  render: ({ field }) =>
