        ...
        children: [
          _jsx(Grid, {
            ...
            children: _jsx(Typography, {
              variant: 'h3',
              sx: { borderBottom: 1, borderColor: theme.palette.primary.main, paddingY: 1 },
              children: venue.name,
            }),
          }),
          _jsxs(Grid, {
            ...
            children: [
              _jsxs(Typography, {
                ...
                children: [_jsx(EuroIcon, { sx: { color: theme.palette.primary.light } }), venue.price],
              }),
              _jsx(Typography, {
                variant: 'h5',
                ...
                children:
                  venue.location?.city && venue.location?.country
                    ...
                    : _jsxs(Box, {
                        ...
                        gap: 1,
                        alignItems: 'center',
                        children: [_jsx(PlaceIcon, { sx: { color: theme.palette.primary.light } }), 'N/A'],
                      }),
              }),
            ],
          }),
          _jsxs(Grid, {
            ...
            children: [
              _jsxs(Typography, {
                variant: 'h5',
                sx: { display: 'flex', alignItems: 'center', gap: 1 },
                children: [_jsx(StarIcon, { sx: { color: theme.palette.primary.light } }), venue.rating || 'N/A'],
              }),
              _jsxs(Typography, {
                variant: 'h5',
                sx: { display: 'flex', alignItems: 'center', gap: 1, marginTop: 3 },
                children: [_jsx(Person4Icon, { sx: { color: theme.palette.primary.light } }), venue.maxGuests],
              }),
            ],
          }),
          _jsxs(Grid, {
            ...
            my: 1,
            children: [
              _jsx(DefaultSubTitle, { children: 'Description' }),
              _jsx(Typography, { variant: 'body1', marginTop: 1, children: venue.description }),
            ],
          }),
          _jsxs(Grid, {
            container: true,
            spacing: 2,
            children: [
              _jsx(Grid, { size: 12, children: _jsx(DefaultSubTitle, { children: 'Facilities' }) }),
              _jsxs(Grid, {
                size: { xs: 6 },
                children: [
                  _jsxs(Typography, {
                    variant: 'h5',
                    sx: { display: 'flex', alignItems: 'center', gap: 1 },
                    children: [_jsx(WifiIcon, {}), venue.meta?.wifi ? 'Wifi available' : 'No wifi'],
                  }),
                  _jsxs(Typography, {
                    variant: 'h5',
                    sx: { display: 'flex', alignItems: 'center', gap: 1, marginTop: 3 },
                    children: [
                      _jsx(FreeBreakfastIcon, {}),
              ...
              _jsxs(Grid, {
                ...
                children: [
                  _jsxs(Typography, {
                    variant: 'h5',
                    sx: { display: 'flex', alignItems: 'center', gap: 1 },
                    children: [_jsx(PetsIcon, {}), venue.meta?.pets ? 'Pets allowed' : 'No pets'],
                  }),
                  _jsxs(Typography, {
                    variant: 'h5',
                    sx: { display: 'flex', alignItems: 'center', gap: 1, marginTop: 3 },
                    children: [_jsx(LocalParkingIcon, {}), venue.meta?.parking ? 'Parking is available' : 'No parking'],
                  }),
                ],
              }),
            ],
          ...
          _jsx(Grid, {
            size: { xs: 12, sm: 12 },
            sx: { marginTop: 2 },
            children: _jsx(Calendar, { events: bookingEvents || [] }),
          }),
          _jsx(Grid, { size: { xs: 12, sm: 12 }, children: _jsx(DefaultSubTitle, { children: 'Meet your host' }) }),
          _jsx(Grid, {
            size: { xs: 12, sm: 12 },
            children: _jsx(HostDetails, {
              data: {
