                ...
                children: _jsxs(Grid, {
                  ...
                  children: [
                    ...
                    _jsx(Grid, {
                      size: 12,
                      textAlign: { xs: 'center', sm: 'left' },
                      children: isPastBooking
                        ? _jsx(Typography, { variant: 'body1', color: 'error', children: 'This booking has passed' })
                        : _jsxs(Typography, {
                            variant: 'body2',
                            display: 'flex',
                            alignItems: 'center',
                    ...
                    _jsxs(Grid, {
                      ...
                      children: [
                        _jsx(Typography, { variant: 'h6', children: dateFrom.format('DD/MM/YYYY') }),
                        _jsx(ArrowForwardIcon, {
                          sx: { color: theme.palette.primary.light, fontFamily: theme.typography.h5 },
                        }),
                        _jsx(Typography, { variant: 'h6', children: dateTo.format('DD/MM/YYYY') }),
                        _jsxs(Typography, {
                          variant: 'h6',
                    ...
                    _jsxs(Grid, {
                      ...
                      children: [
                        ...
                        _jsxs(Typography, {
                          textAlign: { xs: 'center', sm: 'left' },
                          variant: 'h6',
                          children: ['Total Cost: \u20AC', totalCost.toFixed(2)],
                        }),
                      ],
                    }),
                    _jsx(Grid, {
                      ...
                      children: _jsxs(Typography, {
                        ...
                        children: ['Last updated: ', dayjs(booking.updated).format('DD/MM/YYYY')],
                      }),
                    }),
                  ],
                }),
              ...
              children: [
                _jsx(SecondaryButton, {
                  children: _jsxs(Button, {
                    ...
                    sx: { width: '40%' },
                    children: [_jsx(EditIcon, { sx: { fontSize: '1rem' } }), ' Edit'],
                  }),
                }),
                _jsx(DefaultButton, {
                  children: _jsxs(Button, {
                    ...
                    sx: { width: '60%' },
                    children: ['Venue details ', _jsx(ArrowForwardIosIcon, {})],
                  }),
                }),
              ],
            }),
          isUpdating &&
            _jsx(Card, {
              ...
              children: booking.venue
                ...
                : _jsx(Typography, { color: 'error', children: 'Venue information is missing.' }),
            }),
        ],
      });
    }),
