...
function UserProfileCard() {
  ...
  if (!profile) {
    return _jsx(Typography, {
      ...
      align: 'center',
      sx: { mt: 4 },
      children: 'No profile found, please log out and log in again.',
    });
  }
  return _jsxs(MainCard, {
    children: [
      _jsx(CardContent, { sx: { margin: 0, padding: 0 }, children: _jsx(HostDetails, { data: profile }) }),
      _jsx(CardContent, {
        sx: { display: 'flex', justifyContent: 'end', my: 2, paddingBottom: 0 },
        children: _jsx(SecondaryButton, {
          children: _jsx(Button, { onClick: handleEditClick, 'aria-label': 'Edit profile', children: 'EDIT PROFILE' }),
        }),
      }),
      isEditing &&
        _jsx(Box, {
          sx: { padding: 1, borderTop: '1px solid #e0e0e0' },
          children: _jsx(EditProfile, {
