...
function ManageVenuePage() {
    ...
    return (_jsx(Container, { maxWidth: "md", children: _jsxs(Grid, { container: true, spacing: 0.5, marginTop: 2, children: [_jsx(Grid, { size: { xs: 12, sm: 5 }, sx: {
                    ...
                    }, children: _jsx(UserProfileCard, {}) }), _jsxs(Grid, { size: { xs: 12, sm: 7 }, children: [loading ? _jsx(LinearProgress, { color: "secondary" }) : null, _jsx(ManagedVenuesCard, { venues: venues, refreshVenues: fetchManagedVenues }), " "] })] }) }));
}
