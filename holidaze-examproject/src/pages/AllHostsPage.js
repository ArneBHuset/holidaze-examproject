...
function AllHostsPage() {
    ...
    return (_jsx(Container, { maxWidth: "md", children: _jsxs(Grid, { container: true, spacing: 0.5, marginTop: 2, children: [_jsx(Grid, { size: { xs: 12, sm: 5 }, sx: {
                        maxWidth: { xs: '100%', sm: '500px' },
                        position: isSmallScreen ? 'static' : 'sticky',
                        top: isSmallScreen ? 'auto' : '20px',
                        alignSelf: 'flex-start',
                    }, children: _jsx(MainCard, { children: _jsx(Box, { mb: 2, children: hostData ? _jsx(HostDetails, { data: hostData }) : _jsx("p", { children: "No host data found" }) }) }) }), _jsx(Grid, { size: { xs: 12, sm: 7 }, children: venues.length > 0 ? (venues.map((venue) => (_jsx(Grid, { size: 12, children: _jsx(MainVenueCard, { venues: [venue] }) }, venue.id)))) : (_jsx("p", { children: "No venues found for this host." })) })] }) }));
}
