...
export default function LandingPage() {
  ...
  const fetchVenueData = useCallback(
    debounce(async (searchValue, sortField, sortOrder) => {
      try {
        setLoading(true);
        const queryParams = {
          search: searchValue || '',
    ...
    children: _jsxs(Grid, {
      ...
      children: [
        _jsx(Grid, {
          ...
          children: _jsx(MainFilterCard, { onSearch: handleSearchChange, onSortChange: handleSortChange }),
        }),
        _jsxs(Grid, {
          size: { xs: 12, sm: 8 },
          children: [
            ...
            filteredVenueData.length === 0 && !loading
              ...
              : _jsx(MainVenueCard, { venues: filteredVenueData }),
          ],
        }),
      ],
    }),
