    ...
    children: _jsxs(Grid, {
      ...
      children: [
        _jsxs(Grid, {
          size: { xs: 12 },
          children: [
            _jsx(DefaultSubTitle, { children: 'search' }),
            _jsx(DefaultInput, {
            ...
            submittedSearchTerm &&
              _jsxs(Box, {
                ...
                paddingX: 1,
                children: [
                  _jsx(Typography, { variant: 'body1', children: submittedSearchTerm }),
                  _jsx(IconButton, { onClick: handleClearSearch, size: 'small', children: _jsx(CloseIcon, {}) }),
                ],
              }),
            _jsx(Box, {
              display: 'flex',
        ...
        _jsxs(Grid, {
          ...
          mb: 2,
          children: [
            _jsx(DefaultSubTitle, { children: 'Sort' }),
            _jsx(Box, {
              display: 'flex',
              flexDirection: 'column',
              gap: 2,
              children: ['price', 'maxGuests', 'rating'].map((sortField) =>
                _jsxs(
                  Box,
                  {
                    display: 'flex',
                    ...
                    children: [
                      ...
                      _jsxs(Typography, {
                        ...
                        sx: {
                          ...
                          borderBottom:
                            selectedSort === sortField ? `2px solid ${theme.palette.secondary.main}` : 'none',
                        },
                        children: [
                          sortField.charAt(0).toUpperCase() + sortField.slice(1),
                          selectedSort === sortField &&
                            (sortOrder === 'asc'
                              ? _jsx(ArrowDropUpIcon, { sx: { fontSize: 30 } })
                              : _jsx(ArrowDropDownIcon, { sx: { fontSize: 30 } })),
                        ],
                      }),
                    ],
                  },
