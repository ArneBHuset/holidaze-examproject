...
const theme = useTheme()
  ...
  <Card sx={{ backgroundColor:(alpha(theme.palette.primary.light, 0.8))}}>
    <CardContent sx={{ backgroundColor:(alpha(theme.palette.primary.light, 0))}}>
      <Box sx={{ textAlign: {xs:'left', sm:'left' }, borderRadius: 2, padding: 4, color:theme.palette.primary.light}}>
          <Typography variant='h1' sx={{ color:theme.palette.secondary.main,   fontSize: {
