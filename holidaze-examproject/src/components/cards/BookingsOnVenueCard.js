  ...
  return _jsx(CardContent, {
    children: _jsxs(Grid, {
      ...
      children: [
        _jsx(Grid, {
          size: 12,
          children: _jsx(Calendar, { events: bookingEvents || [], onEventClick: handleEventClick }),
        }),
        _jsx(Grid, {
          size: 12,
          sx: { mt: 2 },
          children: selectedBooking
            ? _jsxs(Grid, {
                ...
                children: [
                  _jsxs(Grid, {
                    ...
                    width: '100%',
                    children: [
                      _jsx(DefaultSubTitle, { children: 'Customer Details' }),
                      _jsx(HostDetails, {
                        data: {
                  ...
                  _jsxs(Grid, {
                    ...
                    width: '100%',
                    children: [
                      _jsx(Grid, { size: 12, children: _jsx(DefaultSubTitle, { children: 'Booking Details' }) }),
                      _jsxs(Grid, {
                        size: 12,
                        my: 1,
                        display: 'flex',
                        ...
                        children: [
                          _jsx(Typography, {
                            variant: 'h6',
                            children: new Date(selectedBooking.dateFrom).toLocaleDateString(),
                          }),
                          ...
                          _jsx(Typography, {
                            variant: 'h6',
                            children: new Date(selectedBooking.dateTo).toLocaleDateString(),
                          }),
                        ],
                      }),
                      _jsx(Grid, {
            ...
            : _jsx(Typography, { variant: 'h5', children: 'Click on an event to view the booking details.' }),
        }),
      ],
    }),
  });
