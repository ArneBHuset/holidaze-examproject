          ...
          ? _jsxs(Box, {
              ...
              children: [
                _jsx(Button, {
                  ...
                  children: _jsx(ArrowBackIosIcon, { sx: { fontSize: 40 } }),
                }),
                _jsx(Box, {
                  height: '250px',
                  p: 1,
                ...
                _jsx(Button, {
                  ...
                  children: _jsx(ArrowForwardIosIcon, { sx: { fontSize: 40 } }),
                }),
              ],
            })
          : _jsx(ImageList, {
      ...
      _jsx(Modal, {
        ...
        children: _jsx(Box, {
          ...
          children:
            ...
            _jsxs(_Fragment, {
              children: [
                _jsx(DefaultSubTitle, { children: modalImage.alt || 'Venue Image' }),
                _jsx('img', {
                  src: modalImage.url,
