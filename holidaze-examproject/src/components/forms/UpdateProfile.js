...
function EditProfile({ onClose, currentProfile, onProfileUpdate }) {
  ...
  return _jsxs(Box, {
    ...
    sx: { width: '100%' },
    children: [
      _jsx(Box, { textAlign: 'center', mb: 3, children: _jsx(DefaultSubTitle, { children: 'Edit profile' }) }),
      _jsxs(Grid, {
        container: true,
        spacing: 2,
        children: [
          ...
          errors.formError &&
            _jsx(Grid, {
              ...
              children: _jsxs(Typography, {
                ...
                display: 'flex',
                alignItems: 'center',
                children: [_jsx(PriorityHigh, {}), errors.formError.message],
              }),
            }),
          _jsxs(Grid, {
            size: 12,
            ...
            children: [
              _jsx(SecondaryButton, {
                children: _jsx(Button, { onClick: onClose, 'aria-label': 'Cancel changes', children: 'Cancel' }),
              }),
              _jsx(DefaultButton, {
                children: _jsx(Button, { type: 'submit', 'aria-label': 'Save changes', children: 'Save Changes' }),
              }),
            ],
          }),
        ],
