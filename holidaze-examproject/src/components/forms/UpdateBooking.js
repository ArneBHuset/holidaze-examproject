...
export default function UpdateBooking({ booking, onCancel, onUpdate }) {
    ...
    return (_jsxs(FormControl, { component: "fieldset", sx: { width: '100%' }, children: [_jsxs(Grid, { container: true, spacing: 1, maxWidth: "sm", margin: 'auto', padding: 2, children: [_jsx(Grid, { size: 12, mb: 1, textAlign: "center", children: _jsx(DefaultSubTitle, { children: "EDIT BOOKING" }) }), _jsxs(Grid, { size: 6, children: [_jsx(Box, { mb: 1, children: _jsx(DefaultSubTitle, { children: "Check-in" }) }), _jsx(LocalizationProvider, { dateAdapter: AdapterDayjs, children: _jsx(Controller, { name: "checkInDate", control: control, render: ({ field }) => (_jsx(DatePicker, { ...field, disablePast: true, onChange: (newDate) => {
                                            field.onChange(newDate);
                                            setValue('checkOutDate', null);
                                        }, value: field.value || null, slots: { textField: TextField }, slotProps: {
                                            textField: {
                                        ...
                                        } })) }) })] }), _jsxs(Grid, { size: 6, children: [_jsx(Box, { mb: 1, children: _jsx(DefaultSubTitle, { children: "Check-out" }) }), _jsx(LocalizationProvider, { dateAdapter: AdapterDayjs, children: _jsx(Controller, { name: "checkOutDate", control: control, render: ({ field }) => (_jsx(DatePicker, { ...field, disablePast: true, minDate: checkInDate ? checkInDate.add(1, 'day') : dayjs(), disabled: !checkInDate, value: field.value || null, slots: { textField: TextField }, slotProps: {
                                            textField: {
                                        ...
                                        } })) }) })] }), _jsxs(Grid, { size: 6, children: [_jsx(DefaultSubTitle, { children: "Guests" }), _jsx(FormControl, { fullWidth: true, children: _jsx(Controller, { name: "guests", control: control, render: ({ field }) => (_jsx(DefaultInput, { children: _jsx(TextField, { ...field, fullWidth: true, type: "number", placeholder: "Number of guests", variant: "standard", error: !!errors.guests, helperText: errors.guests ? errors.guests.message : '' }) })) }) })] }), _jsxs(Grid, { size: 6, children: [_jsx(DefaultSubTitle, { children: "Max guests" }), _jsxs(Typography, { variant: "h6", sx: { display: 'flex', alignItems: 'center', gap: 1, marginTop: 2 }, children: [_jsx(Person4Icon, { sx: { color: 'secondary.main', fontSize: 28 } }), venue?.maxGuests || 0] })] }), _jsx(Grid, { size: 6, children: _jsx(SecondaryButton, { children: _jsxs(Button, { fullWidth: true, onClick: () => makeApiCall('DELETE'), sx: { gap: 1 }, children: [_jsx(DeleteOutlineIcon, {}), " Delete"] }) }) }), _jsx(Grid, { size: 6, children: _jsx(SecondaryButton, { children: _jsxs(Button, { fullWidth: true, onClick: handleSubmit((data) => {
                                    const updateData = {
                                ...
                                }), sx: { gap: 1 }, children: [_jsx(SaveIcon, {}), "Save"] }) }) })] }), _jsx(DefaultButton, { children: _jsxs(Button, { fullWidth: true, onClick: onCancel, children: ["Cancel", _jsx(KeyboardArrowUpIcon, {})] }) })] }));
}
